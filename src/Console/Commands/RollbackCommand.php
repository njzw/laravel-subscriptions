...
class RollbackCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'nigel:rollback:subscriptions {--f|force : Force the operation to run when in production.}';
     ...
     * @var string
     */
    protected $description = 'Rollback Nigel Subscriptions Tables.';
